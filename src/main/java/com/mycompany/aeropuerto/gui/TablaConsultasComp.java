 ...
 * @author Diego
 */
public class TablaConsultasComp extends javax.swing.JDialog {

    /**
     * Creates new form TablaConsultasComp
     */
    public TablaConsultasComp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tblComp.setModel(new CompTableModel(LogicaNegocio.leerCompanyasCSV()));
    }
     public TablaConsultasComp() {
        ...
        tblComp.setRowSorter(OrdenComp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaConsultasComp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TablaConsultasComp dialog = new TablaConsultasComp(new javax.swing.JFrame(), true);
